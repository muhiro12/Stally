...
private extension StallyItemDetailView {
    ...
    var heroSection: some View {
        VStack(alignment: .leading, spacing: theme.spacing.group) {
            ...
            if item.isArchived {
                Label(
                    "Archived items stay out of the Library until you move them back.",
    ...
    var toggleArchiveStateButton: some View {
        Button {
            ...
            Label(
                item.isArchived
                    ? StallyLocalization.string("Move Back to Library")
    ...
    var selectedDaySection: some View {
        Section("Selected Day") {
            ...
            if item.isArchived {
                Text("Archived items are read-only. Move this item back to the Library to change history.")
                    .mhRowSupporting()
            }
        }
    }
